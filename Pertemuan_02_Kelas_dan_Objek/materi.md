# Materi Pertemuan 02 — Kelas dan Objek
...
Solusinya adalah mendefinisikan method `__str__` (akan dipelajari detail di Pertemuan 09):
...
> 📌 Untuk sekarang, kita menggunakan method `info()` atau `tampilkan_info()` sebagai alternatif yang lebih eksplisit. Kita akan bahas `__str__` detail di Pertemuan 09.
...
*➡️ Lanjut ke: [Pertemuan 03 — Atribut dan Method](../Pertemuan_03_Atribut_dan_Method/materi.md)*
